    ...
    <center>
        ...
        <table width="500">
            <tr>
                ...
                <td>
                <td class='text-justify'>
                    <font size="2">Rencana kegiatan Magang Industri (MI) tersebut akan dilaksanakan selama 4 bulan mulai
                        {{$surat->tanggal_mulai}} sd {{$surat->tanggal_selesai}} dengan jumlah mahasiswa 8 (delapan)
                        orang sebagaimana
                        daftar terlampir.
                    </font>
                </td>
        ...
        <table width="">
            <tr>
                ...
                <td class="text" align="center"> <br> <br>
                    Samarinda, {{ $surat->created_at }}<br> A.n. Direktur
                    <br>{{ $surat->created_at }},<br><br><br><br>Dr.Heriad Daud Salusu, S.Hut, MP
...
<body>
    <center>
        ...
        <table width="">
            <tr>
                <td width="350"><br><br><br><br></td>
                <td class="text" text-align="center"> <br> <br><br><br><br><br><br><br><br><br>
                    Samarinda, {{ $surat->created_at }}<br> A.n. Direktur
                    <br>{{ $surat->created_at }},<br><br><br><br>Dr.Heriad Daud Salusu, S.Hut, MP
                    NIP. 19700830 199703 1 001
                </td>
