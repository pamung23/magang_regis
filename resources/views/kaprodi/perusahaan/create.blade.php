                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{ route('kaprodi.perusahaan.store') }}" method="Post">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="kota_kecamatan" class="form-control"
                                            placeholder="Kota kecamatan" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="no_perusahaan" class="form-control"
                                            placeholder="No Perusahaan" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="no_telpn_contact_person" class="form-control"
                                            placeholder="Nomor telpon contact person" required>
                                    </div>
